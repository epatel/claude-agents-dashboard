...
```bash
./run-tests.sh              # Run all 1215 tests
...
│   ├── test_kimi_session.py         # KimiAgentSession (experimental runtime) (12 tests)
...
- `KimiAgentSession`: message/tool-call mapping, missing-SDK hint, cancel, errors (12)
