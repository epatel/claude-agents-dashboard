...
**Current state**: 983 automated tests across 32 test files (including conftest.py) via `./run-tests.sh`, plus 5 E2E tests via `./run-e2e-tests.sh`. Database has 21 migrations.
